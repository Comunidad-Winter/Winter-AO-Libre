...
'                If tempint = Val(ReadField(2, Rdata, 44)) Then
    ...
    With charlist(CharIndex)
        ...
        .Nombre = charlist(CharIndex).Nombre
        .Criminal = charlist(CharIndex).Criminal
        .priv = charlist(CharIndex).priv
    End With
    
    'Call MakeChar(CharIndex, Body, Head, Heading, x, y, weapon, shield, hemlet)
