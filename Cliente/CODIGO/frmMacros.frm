...
'******************************************************************************************************
'Standelf - Macros internos Configurables Con Renderizado en el frmMain.
'******************************************************************************************************
'Permite:
'Programar la tecla para un Comando.
'Programar la tecla para usar el item del Slot seleccionado.
'Programar la tecla para equipar el item Slot seleccionado.
'Lanzar el hechizo del Slot seleccionado.
'Renderizado en el frmMain
'******************************************************************************************************
...
'Guarda las acciones en el Macros.Bin, que se ubica en la carpeta INIT del cliente.
'Dibuja en el frmmain la accion seleccionada.
'******************************************************************************************************
'Standelf || 27-Septiembre-2008 || 2ª Revision y optimización 12-Octubre-2008
'EzequielJuarez@live.com.ar
'******************************************************************************************************
