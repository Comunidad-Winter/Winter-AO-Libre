...
For Hechizo = 1 To NumeroHechizos
    ...
    Hechizos(Hechizo).TeleportX = Leer.GetValue("Hechizo" & Hechizo, "Teleport")
    Hechizos(Hechizo).TeleportXMap = Leer.GetValue("Hechizo" & Hechizo, "TeleportMap")
    Hechizos(Hechizo).TeleportXX = Leer.GetValue("Hechizo" & Hechizo, "TeleportX")
    Hechizos(Hechizo).TeleportXY = Leer.GetValue("Hechizo" & Hechizo, "TeleportY")
    ...
    Hechizos(Hechizo).ExclusivoClase = UCase$(Leer.GetValue("Hechizo" & Hechizo, "ExclusivoClase")) ' Shed > Getvalue
    ...
    Hechizos(Hechizo).NBaculo = CBool(val(Leer.GetValue("Hechizo" & Hechizo, "NBaculo")))
Next Hechizo
...
Call WriteVar(UserFile, "FLAGS", "TCOJE", CStr(UserList(UserIndex).flags.tCoje))
...
Call WriteVar(UserFile, "Inventory", "MonturaSlot", str(UserList(UserIndex).Invent.BarcoSlot))
