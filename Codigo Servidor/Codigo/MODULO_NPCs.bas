   ...
   If UserIndex > 0 Then ' Lo mato un usuario?
        ...
        End If
         If MiNPC.GiveGLD > 0 Then
            Call SendData(ToIndex, UserIndex, 0, "||Has ganado " & MiNPC.GiveGLD & " monedas de oro al matar a la criatura." & FONTTYPE_FIGHT)
        Else
...
Call SendData(ToIndex, UserIndex, 0, "||Has ganado " & MiNPC.GiveGLD & " Monedas de Oro." & FONTTYPE_FIGHT)
