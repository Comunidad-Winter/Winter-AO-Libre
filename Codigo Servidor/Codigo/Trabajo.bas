...
Call SendData(SendTarget.toindex, UserIndex, 0, "NG")
...
Call SendData(toindex, UserIndex, 0, "||No puedes utilizar la montura mientras navegas !!" & FONTTYPE_INFO)
Exit Sub
End If
...
Public Sub CarpinteroConstruirItem(ByVal UserIndex As Integer, ByVal ItemIndex As Integer, Cantidad As Integer)
...
Dim obji As Integer
    ...
    If UserList(UserIndex).Invent.Object(Slot).Amount < 20 Then
...
If res < 6 Then
    ...
    If UCase$(UserList(UserIndex).Clase) = "LEÑADOR" Then
        MiObj.Amount = RandomNumber(50, 25)
    Else
        MiObj.Amount = 1
    End If
...
Call SendData(SendTarget.toindex, UserIndex, 0, "AF1")
...
Call SendData(SendTarget.toindex, UserIndex, 0, "AF0")
...
If res <= 5 Then
    ...
    If UCase$(UserList(UserIndex).Clase) = "MINERO" Then
        MiObj.Amount = RandomNumber(25, 20)
    Else
        MiObj.Amount = 1
    End If
